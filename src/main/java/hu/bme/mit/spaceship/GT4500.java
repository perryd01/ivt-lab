    ...
    switch (firingMode) {
      ...
      case ALL:
        ...
        if (!primaryTorpedoStore.isEmpty() && !secondaryTorpedoStore.isEmpty()) {
          var primaryFiringSucess = primaryTorpedoStore.fire(1);
          var secondaryFiringSucess = secondaryTorpedoStore.fire(1);

          firingSuccess = primaryFiringSucess && secondaryFiringSucess;
        }
